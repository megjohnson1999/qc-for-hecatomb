...
def extract_host_removal_stats(merged_bam, unmerged_bam):
    ...
    # Calculate percentage of host reads (assuming host reads are mapped reads)
    ...
    # For paired data, we need to consider reads that are completely unmapped
...
# Example code to use the function and generate summary stats
