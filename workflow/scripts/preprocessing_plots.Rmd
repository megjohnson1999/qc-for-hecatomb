...
```{r, echo=FALSE, warning=FALSE}
# Create plots for PrimerB and PrimerB_rc
p1 <- ggplot(primer_b, aes(x="", y=percent_with_primerB))+
  geom_boxplot(outlier.shape=NA)+
  geom_jitter(width=0.2) +
  theme_bw() +
...
p2 <- ggplot(primer_b, aes(x="", y=percent_with_primerB_rc))+
  geom_boxplot(outlier.shape=NA)+
  geom_jitter(width=0.2) +
  theme_bw() +
  ylab("Percent of reads") +
...
# Plot total PrimerB contamination
ggplot(primer_b, aes(x="", y=percent_total_primerB))+
  geom_boxplot(outlier.shape=NA)+
  geom_jitter(width=0.2) +
  theme_bw() +
...
```{r, echo=FALSE, warning=FALSE}
# Create the plot for vector contamination
ggplot(vector, aes(x="", y=percent_with_vector))+
  geom_boxplot(outlier.shape=NA)+
  geom_jitter(width=0.2) +
  theme_bw() +
...
```{r, echo=FALSE, warning=FALSE}
# Create the plot for percent merged
ggplot(bbmerge, aes(x="", y=percent_merged))+
  geom_boxplot(outlier.shape=NA)+
  geom_jitter(width=0.2) +
  theme_bw() +
...
p1 <- ggplot(host, aes(x="", y=percent_host_in_merged))+
  geom_boxplot(outlier.shape=NA)+
  geom_jitter(width=0.2) +
  theme_bw() +
...
p2 <- ggplot(host, aes(x="", y=percent_host_in_unmerged))+
  geom_boxplot(outlier.shape=NA)+
  geom_jitter(width=0.2) +
  theme_bw() +
  ylab("Percent host reads") +
...
ggplot(host, aes(x="", y=percent_host_overall))+
  geom_boxplot(outlier.shape=NA)+
  geom_jitter(width=0.2) +
  theme_bw() +
...
summary_data <- data.frame(
  ...
  Mean_percent = c(
    mean(fastp$percent_adapter_trimmed),
    mean(primer_b$percent_total_primerB),
    mean(vector$percent_with_vector),
    mean(bbmerge$percent_merged),
    mean(host$percent_host_overall)
  ),
  Median_percent = c(
    median(fastp$percent_adapter_trimmed),
    median(primer_b$percent_total_primerB),
    median(vector$percent_with_vector),
    median(bbmerge$percent_merged),
    median(host$percent_host_overall)
  ),
  Min_percent = c(
    min(fastp$percent_adapter_trimmed),
    min(primer_b$percent_total_primerB),
    min(vector$percent_with_vector),
    min(bbmerge$percent_merged),
    min(host$percent_host_overall)
  ),
  Max_percent = c(
    max(fastp$percent_adapter_trimmed),
    max(primer_b$percent_total_primerB),
    max(vector$percent_with_vector),
    max(bbmerge$percent_merged),
    max(host$percent_host_overall)
  )
)
...
kept_percent <- 100 - mean(host$percent_host_overall)
summary_data <- rbind(
  summary_data,
  data.frame(
